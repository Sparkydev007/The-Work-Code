package com.theworkcode.employment.config;
...
public class EmploymentServiceConfig {
    ...
    public static class EmploymentSeedRunner implements ApplicationRunner {
        private final EmploymentService employmentService;

        @Override
        public void run(ApplicationArguments args) {
            employmentService.seedDemoDataIfEmpty();
        }
    }
}
